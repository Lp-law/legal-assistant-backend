...
const buildInitialReportPrompt = (options: {
  ...
  const sections: string[] = [
    ...
    "",
    "### תהליך חובה:",
    "1. עבור כל מומחה תביעה — פרט עובדות, נזק נטען, סטייה/מחדל, קשר סיבתי, והערות על איכות הראיות. לכל טענה ציין `[מקור: שם המסמך/המומחה]`.",
    "2. הצלב את הממצאים עם כתב התביעה או כל מסמך כללי (Statement of Claim) כדי להראות היכן יש התאמות/סתירות בעובדות, באבחנות ובטענות הנזק.",
    "3. הפק רשימת סוגיות רפואיות במחלוקת (פרוצדורה, סטנדרט טיפול, אבחון, פרוגנוזה, קשר סיבתי, מצב קודם).",
    "4. צור מילות חיפוש באנגלית לכל סוגיה (3–8 מונחים: Clinical terms, Imaging, ICD, Treatment, Study type).",
    "5. שלב מקורות מה-10–15 השנים האחרונות (Reviews, Meta-analysis, Guidelines, RCTs) עם ציון תמיכה/סתירה, רלוונטיות וטיעון להגנה.",
    "6. החזר דו\"ח במבנה המדויק שלהלן (Markdown). כל סעיף צריך להיות מפורט ועשיר.",
    "",
    "### מבנה דו\"ח מחייב:",
    "# ניתוח מומחה + סקירת ספרות רפואית",
    "## א. סיכום עובדתי של המקרה",
    "- תאר כרונולוגיה רפואית המדגישה אבחנות, בדיקות וטיפולים; לכל פרט הוסף `[מקור: …]`.",
    "## ב. טענות עיקריות של מומחה/מומחי התביעה",
    "- רשימת bullet נפרדת לכל מומחה, עם ציטוט קצר + \"הערת אמינות\" + `[מקור: שם חוות הדעת]`.",
    "## ג. נקודות חולשה / אי־דיוקים / סתירות בחוות הדעת",
    "- טבלה: | מקור/מסמך | טענה מצוטטת | בעיה רפואית | מה נדרש להשלמה/בדיקה |",
    "## ד. רשימת הסוגיות הרפואיות במחלוקת",
    "- מנקודות הסוגיות להוסיף מילת מפתח קצרה בכל שורה.",
    "## ה. מילות חיפוש באנגלית",
    "- עבור כל סוגיה מסעיף ד' ציין 3–8 מונחים (Clinical / Imaging / ICD / Treatment / Study) כולל מגדר/גיל אם רלוונטי.",
    "## ו. רשימת מאמרים רלוונטיים",
    "- טבלה: | נושא | שם המאמר | שנה | כתב עת | סיכום (2–4 משפטים) | תומך/סותר | רלוונטיות | טיעון להגנה | מקור/DOI |",
    "## ז. מסקנות רפואיות עיקריות מהספרות",
    "- לפחות 5 bullet, כל אחד עם `[מקור: מאמר]`.",
    "## ח. יישום רפואי לטובת ההגנה",
    "- טיעונים חזקים לטובת ההגנה (עובדה + מקור).",
    "- נקודות מסוכנות/רגישות והשלמות נדרשות.",
    "- מומחים משלימים שכדאי לגייס (תחום + סיבה).",
    "- 10–15 שאלות רפואיות מבוססות ספרות למומחה ההגנה (חלוקה לנושאים).",
    "## ט. מילות/משפטי חיפוש מומלצים בעברית ובאנגלית",
    "- לפחות שש הצעות (שילוב עברית/אנגלית) עם מטרה קצרה לכל הצעה.",
    "## י. פערים/משימות להמשך ואיסוף מסמכים",
    "- רשימת פריטים קצרה (לדוגמה: \"בדיקת אנדוסקופיה חוזרת\", \"תיק מלא מביטוח לאומי\"), כל אחד עם הסבר רפואי קצר והקשר לטענה.",
    "",
    "### הנחיות משלימות:",
